...
$templateCache.put("{widgetsPath}/getphd/src/phd/citation.html","<div class=\"bs-callout bs-callout-NOA\"><h4 class=card-title>{{p.title}}</h4><small class=\"text-muted>\">{{p.application}}</small></div>");
