...
angular.module('adf.widget.getphd', ['adf.provider', 'llp.extract',
    'fa.droppable', 'llp.parsetsv', 'roar', 'textSizeSlider',  'LocalStorageModule', 'llp.extractpdf', 'firebase', 'xeditable', 'ui.tree', 'ngAnimate', 'ngAnnotateText', 'ngDialog', 'ngSanitize', 'pdf', 'toastr', 'mentio', 'diff', 'door3.css', 'checklist-model', 'angular-md5', 'angular.filter', 'ngFileUpload'
...
$templateCache.put("{widgetsPath}/getphd/src/titleTemplate.html","<div class=panel-heading style=z-index:1;margin:-1px;><h4 class=panel-title style=-webkit-user-select:none;padding:0;><div uib-dropdown uib-keyboard-nav style=z-index:1000000;><a uib-dropdown-toggle class=\"btn btn-xs vcenter pull-left\"><label class=\"fa fa-bars hovergold\" style=\"cursor:pointer;color:beige;filter:drop-shadow(0 0 2.5px rgba(0,0,0,0.5));\"></label></a><ul class=\"uib-dropdown-menu panel r-action\" style=position:absolute;><li><a class=hovergold style=\"text-shadow:inset 0 0 1px rgba(0,0,0,0.5);\" clipboard text=roarevent.media on-copied=\"alertify.success(\'copied!\');\" on-error=\"alertify.error(err,\'uh oh!\')\" onclick=\"alertify.success(\'copied!\')\"><i class=\"fa fa-link\" style=margin:5px;></i></a></li><li><a class=hovergold style=\"text-shadow:inset 0 0 1px rgba(0,0,0,0.5);\" title=\"collapse widget\" ng-show=!isCollapsed ng-click=\"roar.collapse();$(\'.issuedocpanel\').css({\'height\':\'auto\'});isCollapsed = true\"><i class=\"fa fa-minus\" style=margin:5px;></i></a></li><li><a class=hovergold style=\"text-shadow:inset 0 0 1px rgba(0,0,0,0.5);\" title=\"expand widget\" ng-show=isCollapsed ng-click=\"roar.collapse();$(\'.issuedocpanel\').css({\'height\':\'auto\'});isCollapsed = false\"><i class=\"fa fa-plus\" style=margin:5px;></i></a></li><li><a class=hovergold style=\"text-shadow:inset 0 0 1px rgba(0,0,0,0.5);\" title=\"copy to clipboard\" ng-click=edit(roarevent.id)><i class=\"fa fa-copy\" style=margin:5px;></i></a></li><li><a class=hovergold style=\"text-shadow:inset 0 0 1px rgba(0,0,0,0.5);\" title=\"fullscreen widget\" ng-click=openFullScreen(roarevent.id) ng-show=\"options.maximizable || true\"><i class=\"fa fa-expand\" style=margin:5px;></i></a></li><li><a class=hovergold style=\"text-shadow:inset 0 0 1px rgba(0,0,0,0.5);\" title=\"pop out\" ng-click=openprev><i class=\"fa fa-external-link\" style=margin:5px;></i></a></li><li class=divider></li><li><a class=\"hovergold text-danger\" style=\"text-shadow:inset 0 0 1px rgba(0,0,0,0.5);\" title=\"remove widget\" ng-click=remove() onclick=\"$(this).closest(\'.issuedocpanel\').remove()\"><i class=\"fa fa-close\" style=margin:5px;></i></a></li></ul></div><div class=\"row vcenter\"><small>&nbsp;&nbsp;|&nbsp;&nbsp;</small> <small ng-bind=roarevent.rid ng-click=\"drag = !drag\" ng-class=\"{\':active\':drag}\"></small> <small>&nbsp;&nbsp;|&nbsp;&nbsp;</small> <small style=lead ng-bind=roarevent.title></small> <span class=\"fa {{roarevent.icon}} pull-right\"></span></div><br><em style=margin-left:50px; ng-bind=\"roarevent.date | date\"></em></h4></div>");
