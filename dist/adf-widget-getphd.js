...
angular.module("adf.widget.getphd").run(["$templateCache", function($templateCache) {$templateCache.put("{widgetsPath}/getphd/src/claims.html","<label class=\"badge bg-Applicant pull-right\">{{roarevent.date | date}}</label><div class=\"col-sm-6 card\" ng-repeat=\"claim in roarevent.claims\" style=\"display:flex;align-content:center;flex-flow:row nowrap;justify-content:space-between;\"><textarea class=Applicant ng-model=roarevent.claims[$index] ng-model-options=\"{updateOn:\'default blur\',debounce:{\'default\':5000,\'blur\':0}}\" col=250 rows=6></textarea> <a class=\"fa fa-close text-danger\" ng-click=\"roarevent.claims[$index]=null\"></a> <a ng-click=\"roarevent.claims.unshift(\'NewClaimText\')\" class=\"text-warning fa fa-plus\"></a></div>");
