...
$templateCache.put("{widgetsPath}/getphd/src/titleTemplate.html","<div class=panel-heading style=z-index:1;><h6 class=panel-title><span ng-bind=roarevent.rid class=\"btn fa {{roarevent.icon}}\" ng-mousedown=\"$(\'[draggable]\').attr(\'draggable\',\'true\')\" ng-mouseup=\"$(\'[draggable]\').attr(\'draggable\',\'false\')\"></span> <span style=margin-left:25px; ng-bind=roarevent.title></span> <span id=controls class=pull-right style=position:absolute;right:5px;font-size:12px;><a class=\"hovergold panel-title\" style=\"text-shadow:0 0 1px rgba(0,0,0,0.5);float:right;\" clipboard text=roarevent.media on-copied=\"alertify.success(\'copied!\');\" on-error=\"alertify.error(err,\'uh oh!\')\" onclick=\"alertify.success(\'copied!\')\"><i class=\"fa fa-link\" style=margin:5px;></i></a> <a class=\"hovergold panel-title\" style=\"text-shadow:0 0 1px rgba(0,0,0,0.5);float:right;\" title=\"collapse widget\" ng-show=!isCollapsed ng-click=\"isCollapsed = true\"><i class=\"fa fa-minus\" style=margin:5px;></i></a> <a class=\"hovergold panel-title\" style=\"text-shadow:0 0 1px rgba(0,0,0,0.5);float:right;\" title=\"expand widget\" ng-show=isCollapsed ng-click=\"isCollapsed = false\"><i class=\"fa fa-plus\" style=margin:5px;></i></a> <a class=\"hovergold panel-title\" style=\"text-shadow:0 0 1px rgba(0,0,0,0.5);float:right;\" title=\"copy to clipboard\" ng-click=edit(roarevent.id)><i class=\"fa fa-copy\" style=margin:5px;></i></a> <a class=\"hovergold panel-title\" style=\"text-shadow:0 0 1px rgba(0,0,0,0.5);float:right;\" title=\"fullscreen widget\" ng-click=openFullScreen(roarevent.id) ng-show=\"options.maximizable || true\"><i class=\"fa fa-expand\" style=margin:5px;></i></a> <a class=\"hovergold panel-title\" style=\"text-shadow:0 0 1px rgba(0,0,0,0.5);float:right;\" title=\"pop out\" ng-click=openpreview(roarevent)><i class=\"fa fa-external-link\" style=margin:5px;></i></a> <a class=\"hovergold panel-title\" style=\"text-shadow:0 0 1px rgba(0,0,0,0.5);float:right;\" title=\"remove widget\" ng-click=remove() onclick=$(this).parent().parent().parent().parent().remove()><i class=\"fa fa-close\" style=margin:5px;></i></a></span></h6></div>");
