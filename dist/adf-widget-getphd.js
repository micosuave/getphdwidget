...
$templateCache.put("{widgetsPath}/getphd/src/phd/Pages.html","<label class=\"fa fa-tags text-info\"></label> <label ng-repeat=\"tag in matches track by $index | groupBy: \'tag\'\" class=\"fa fa-tag\">{{tag}}</label><div ng-repeat=\"page in pages\" class=\"card card-block\" style=line-height:1.5;font-size:14px;><p ng-bind-html=\"page | highlight: $parent.query | trustAsHTML\"></p></div>");
