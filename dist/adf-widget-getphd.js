        ...
        return {
            ...
            link: function($scope, $el, $attr, $ctrl) {
                var popdoc = function() {
                    ...
                    interact('.issuedocpanel',{ ignoreFrom: '.panel-heading'})
  .draggable({
