...
$templateCache.put("{widgetsPath}/getphd/src/titleTemplate.html","<div class=panel-heading style=z-index:1;><h4 class=\"panel-title flextoprow\" style=-webkit-user-select:none;><strong ng-bind=roarevent.rid class=\"fa {{roarevent.icon}}\" ng-click=\"drag = !drag\" ng-class=\"{\':active\':drag}\"></strong>&nbsp;&nbsp;|&nbsp;&nbsp; <small style=lead ng-bind=roarevent.title></small><div uib-dropdown uib-keyboard-nav style=z-index:1000000;position:absolute;right:5px;><a uib-dropdown-toggle class=\"btn vcenter pull-right\"><label class=\"label label-pill badge label-{{roarevent.styleClass}} fa fa-ellipsis-v\" style=cursor:pointer;>&nbsp;</label></a><ul class=uib-dropdown-menu style=position:absolute;><li class=list-group-item><a class=hovergold style=\"text-shadow:inset 0 0 1px rgba(0,0,0,0.5);\" clipboard text=roarevent.media on-copied=\"alertify.success(\'copied!\');\" on-error=\"alertify.error(err,\'uh oh!\')\" onclick=\"alertify.success(\'copied!\')\"><i class=\"fa fa-link\" style=margin:5px;></i></a></li><li class=list-group-item><a class=hovergold style=\"text-shadow:inset 0 0 1px rgba(0,0,0,0.5);\" title=\"collapse widget\" ng-show=!isCollapsed ng-click=\"isCollapsed = true\"><i class=\"fa fa-minus\" style=margin:5px;></i></a></li><li class=list-group-item><a class=hovergold style=\"text-shadow:inset 0 0 1px rgba(0,0,0,0.5);\" title=\"expand widget\" ng-show=isCollapsed ng-click=\"isCollapsed = false\"><i class=\"fa fa-plus\" style=margin:5px;></i></a></li><li class=list-group-item><a class=hovergold style=\"text-shadow:inset 0 0 1px rgba(0,0,0,0.5);\" title=\"copy to clipboard\" ng-click=edit(roarevent.id)><i class=\"fa fa-copy\" style=margin:5px;></i></a></li><li class=list-group-item><a class=hovergold style=\"text-shadow:inset 0 0 1px rgba(0,0,0,0.5);\" title=\"fullscreen widget\" ng-click=openFullScreen(roarevent.id) ng-show=\"options.maximizable || true\"><i class=\"fa fa-expand\" style=margin:5px;></i></a></li><li class=list-group-item><a class=\"hovergold panel-title menu-item\" style=\"text-shadow:inset 0 0 1px rgba(0,0,0,0.5);\" title=\"pop out\" ng-click=\"openprevass=\" fa fa-external-link\"></a></li><li class=divider></li><li class=list-group-item><a class=hovergold style=\"text-shadow:inset 0 0 1px rgba(0,0,0,0.5);\" title=\"remove widget\" ng-click=remove() onclick=$(this).parent().parent().parent().parent().remove()><i class=\"fa fa-close\" style=margin:5px;></i></a></li></ul></div></h4></div>");
