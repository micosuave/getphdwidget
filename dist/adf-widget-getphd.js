                  ...
                  .then(function (roarmap) {
                    ...
                    $patentsearch($scope.phd.application, config.PNUM || 8000000)
                      .then(function (patentobj) {
                        ...
                        $scope.phd.media = $location.host() + '/files/public/uspto/index#?='
                        $scope.phd.name = 'PhD for ' + $scope.phd.patent.number;
                        $scope.phd.styleClass = 'NOA';
                        $scope.phd.rid = 'PHD';
                        localStorageService.set($scope.phd.application['Application Number'], $scope.phd);
                        $http.post($location.host() + '/getphd/store/' + $scope.phd.appnum)
                        main.showupload = false;
