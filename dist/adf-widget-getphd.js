...
function addpatent (groupids, phd){
     ...
     }]).filter('roarmap', ["APPDOCCODES", "PTODOCCODES", "INTVDOCCODES", "PETDOCCODES", "NOADOCCODES", "DOCNAMES", "ckstarter", "ckender", function(APPDOCCODES,PTODOCCODES,INTVDOCCODES,PETDOCCODES,NOADOCCODES,DOCNAMES,ckstarter,ckender){
