...
$templateCache.put("{widgetsPath}/getphd/src/fulltext.html","<doc-header class=\"container-fluid card two-col-right\" roarid={{roarevent.id}}><div matches=matches getpdftext={{roarevent.$id}} pdf-data={{roarevent.$id}} roarevent=roarevent class=\"card card-block\"></div></doc-header>");
