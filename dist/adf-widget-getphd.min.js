!function(e,t){"use strict";var a=angular.module("adf.widget.getphd",["adf.provider","llp.extract","llp.parsetsv","roar","LocalStorageModule","firebase","xeditable","ui.tree","ngAnimate","ngAnnotateText","ngDialog","ngSanitize","pdf","toastr","mentio","diff","angularCSS","checklist-model","angular-md5","angular.filter","ngFileUpload","angularFileUpload","pageslide-directive"]).config(["dashboardProvider","localStorageServiceProvider",function(e,t){t.setPrefix("adf.getphd"),e.widget("website",{title:"Web Report",description:"configure the collection shell",templateUrl:"{widgetsPath}/getphd/src/webdata.html",icon:"fa-globe",iconurl:"/llp_core/img/lexlab.svg",styleClass:"NOA",frameless:!1,reload:!0,controller:"MetadataController",controllerAs:"meta",edit:{templateUrl:"{widgetsPath}/getphd/src/webdataedit.html",controller:"MetadataController",controllerAs:"web",modalSize:"lg",reload:!0}}).widget("metadata",{title:"Metadata",description:"metadata for this document/collection",templateUrl:"{widgetsPath}/getphd/src/metadata.html",icon:"fa-code",iconurl:"/llp_core/img/lexlab.svg",styleClass:"info",frameless:!1,reload:!0,controller:"MetadataController",controllerAs:"meta",edit:{templateUrl:"{widgetsPath}/getphd/src/metadata.html",controller:"MetadataController",controllerAs:"meta",modalSize:"lg",reload:!0}}).widget("report",{title:"Report",description:"filehistory report ",templateUrl:"{widgetsPath}/getphd/src/report.html",icon:"fa-code",iconurl:"/llp_core/img/lexlab.svg",styleClass:"info",frameless:!1,reload:!0,controller:"RepoController",controllerAs:"report"}).widget("claims",{title:"Claims",description:"view or edit a set of claims",templateUrl:"{widgetsPath}/getphd/src/claims.html",icon:"fa-code",iconurl:"/llp_core/img/lexlab.svg",styleClass:"info",frameless:!1,reload:!0,controller:"ClaimWidgetController",controllerAs:"cwc",edit:{templateUrl:"{widgetsPath}/getphd/src/editfulltext.html",controller:"TextController",controllerAs:"text",modalSize:"lg",reload:!0}}).widget("text",{title:"TextAnnotator",description:"full search and annotate a document",templateUrl:"{widgetsPath}/getphd/src/fulltext.html",icon:"fa-file-o",iconurl:"/llp_core/img/lexlab.svg",styleClass:"info ",frameless:!1,reload:!0,controller:"TextController",controllerAs:"text",edit:{templateUrl:"{widgetsPath}/getphd/src/editfulltext.html",controller:"TextController",controllerAs:"text",modalSize:"lg",reload:!0}}).widget("patent",{title:"PatentDigest",description:"analysis of patent or published application",templateUrl:"{widgetsPath}/getphd/src/phd/patentReport.html",controller:"PatentWidgetCtrl",controllerAs:"p",frameless:!1,reload:!1,icon:"fa-ge",iconurl:"img/logolong.png",styleClass:"NOA panel panel-NOA",edit:{templateUrl:"{widgetsPath}/getphd/src/edit.html",controller:"PatentWidgetCtrl",controllerAs:"p",modalSize:"lg",reload:!0,immediate:!0}}).widget("getphd",{title:"+PhD",description:"import a patent prosecution history",templateUrl:"{widgetsPath}/getphd/src/view.html",controller:"MainCtrl",controllerAs:"main",frameless:!1,reload:!1,icon:"fa-ge",iconurl:"img/logolong.png",styleClass:"primary panel panel-primary",edit:{templateUrl:"{widgetsPath}/getphd/src/edit.html",controller:"MainCtrl",controllerAs:"main",modalSize:"lg",reload:!0}}).widget("roartable",{title:"ROARtable",description:"ROARMAP in tabular form",templateUrl:"{widgetsPath}/getphd/src/roartable.html",controller:"RoartableCtrl",controllerAs:"roartable",frameless:!1,reload:!1,icon:"fa-ge",iconurl:"img/logolong",styleClass:"primary panel panet-primary",edit:{templateUrl:"{widgetsPath}/getphd/src/roartableedit.html",controller:"RoartableCtrl",controllerAs:"roartable",modalsize:"lg",reload:!0}})}]).controller("RoartableCtrl",[function(){}]).directive("fileUploadDirective",[function(){return{restrict:"EA",templateUrl:"{widgetsPath}/getphd/src/fileuploaddirective.html",controller:"FileUploadDirectiveCtrl",link:function(e,t,a,i){}}}]).controller("FileUploadDirectiveCtrl",["FileUploader","$scope",function(e,t){var a=this,i=t.uploader=new e({url:"/upload",autoUpload:!0,removeAfterUpload:!0});i.onWhenAddingFileFailed=function(e,t,a){console.info("onWhenAddingFileFailed",e,t,a)},i.onAfterAddingFile=function(e){console.info("onAfterAddingFile",e)},i.onAfterAddingAll=function(e){console.info("onAfterAddingAll",e)},i.onBeforeUploadItem=function(e){console.info("onBeforeUploadItem",e),a.progress=0,a.bufferedfile=e,console.log(e),alertify.log("starting upload...")},i.onProgressItem=function(e,t){a.progress=t,10===t&&toastr.info("fetching remote resources..."),30===t&&toastr.info("loading relevant data schemas..."),55===t&&toastr.warning("compiling templates..."),75===t&&toastr.warning("starting the AI engine..."),t<=40?a.progresstype="danger":t>40&&t<66?a.progresstype="warning":t>97?a.progresstype="success":a.progresstype="info",console.info("onProgressItem",e,t)},i.onProgressAll=function(e){console.info("onProgressAll",e)},i.onSuccessItem=function(e,t,a,i){console.info("onSuccessItem",e,t,a,i),alertify.success(t),alertify.success("File uploaded!"),$rootScope.$broadcast("UPLOADCOMPLETE",t)},i.onErrorItem=function(e,t,i,l){console.info("onErrorItem",e,t,i,l),a.progress="failed",a.progresstype="danger"},i.onCancelItem=function(e,t,a,i){console.info("onCancelItem",e,t,a,i)},i.onCompleteItem=function(e,t,a,i){console.info("onCompleteItem",e,t,a,i),alertify.success(t),$rootScope.$broadcast("UPLOADCOMPLETE")},i.onCompleteAll=function(){console.info("onCompleteAll"),$rootScope.$broadcast("UPLOADCOMPLETE")},console.info("uploader",i)}]).controller("MainCtrl",["Collection","extract","extractzip","fileReader","$http","parseTSV","$roarmap","$q","$scope","PHD","localStorageService","extractpdf","$patentsearch","$log","FileUploader","$publish","$pdftotxt","$timeout","toastr","$rootScope","$stateParams","$location","$ACTIVEROAR","$dashboards","$interval","$compile","$templateCache","$window","$document","$filter","ckstarter","ckender","$firequeue","$state",function(e,t,a,i,l,n,o,r,s,c,d,p,g,u,b,f,m,h,v,y,x,w,k,C,A,P,O,E,D,S,T,I,R,U){var N=this;s.treeFilter=S("uiTreeFilter"),s.availableFields=["title","text"],s.supportedFields=["title","text"],s.toggleSupport=function(e){return s.supportedFields.indexOf(e)>-1?s.supportedFields.splice(s.supportedFields.indexOf(e),1):s.supportedFields.push(e)},s.collapsereport=!1,N.collapse=function(){s.collapsereport=!s.collapsereport};var M=s.$parent.config||s.$parent.$parent.config;s.config=M;var c=e(M.id)||e(M.appnum);c.$loaded().then(function(e){e.$bindTo(s,"phd"),angular.isUndefined(e.file)?N.showupload=!0:N.showupload=!1});var F=e(M.appnum||M.id);s.application=F,N.$ACTIVEROAR=k,N.tabs=[{isActive:!0,disabled:!1},{isActive:!1,disabled:!1},{isActive:!1,disabled:!1}],s.export2collection=function(t){var a=x.pId,i=e(a);i.$loaded().then(function(e){angular.isUndefined(e.roarlist)?(e.roarlist=new Array,e.roarlist.push(t),e.$save()):(e.roarlist.push(t),e.$save())})},s.publish=function(e){angular.forEach(e.roarmap.collections,function(e,t){s.export2collection(e),s.export2collection(t)}),s.export2collection(M.id),f(M.id,s.phd).then(function(e){alertify.success("link to post:"+e)})};var L={header:!0,skipEmptyLines:!0},_=s.uploader=new b({url:"/upload",autoUpload:!0,removeAfterUpload:!0});_.filters.push({name:"customFilter",fn:function(e,t){var a=e.filename||e.name;return a.indexOf(".zip")>-1&&a.indexOf("(")==-1&&a.indexOf(" ")==-1}}),_.onWhenAddingFileFailed=function(e,t,a){console.info("onWhenAddingFileFailed",e,t,a),alertify.alert('The file\'s name must end with ".zip" and consist only of numbers'),this.queue=null},_.onAfterAddingFile=function(e){console.info("onAfterAddingFile",e)},_.onAfterAddingAll=function(e){console.info("onAfterAddingAll",e)},_.onBeforeUploadItem=function(e){console.info("onBeforeUploadItem",e),N.progress=0,N.bufferedfile=e,console.log(e),alertify.log("starting upload...")},_.onProgressItem=function(e,t){N.progress=t,10===t&&v.info("fetching remote resources..."),30===t&&v.info("loading relevant data schemas..."),55===t&&v.warning("compiling templates..."),75===t&&v.warning("starting the AI engine..."),t<=40?N.progresstype="danger":t>40&&t<66?N.progresstype="warning":t>97?N.progresstype="success":N.progresstype="info",console.info("onProgressItem",e,t)},_.onProgressAll=function(e){console.info("onProgressAll",e)},_.onSuccessItem=function(e,t,a,i){console.info("onSuccessItem",e,t,a,i),alertify.success(t),alertify.success("File uploaded!"),y.$broadcast("UPLOADCOMPLETE",t)},_.onErrorItem=function(e,t,a,i){console.info("onErrorItem",e,t,a,i),N.progress="failed",N.progresstype="danger"},_.onCancelItem=function(e,t,a,i){console.info("onCancelItem",e,t,a,i)},_.onCompleteItem=function(e,t,a,i){console.info("onCompleteItem",e,t,a,i),alertify.success(t),y.$broadcast("UPLOADCOMPLETE")},_.onCompleteAll=function(){console.info("onCompleteAll"),y.$broadcast("UPLOADCOMPLETE")},console.info("uploader",_),N.treeFilter=S("uiTreeFilter"),N.toggle=function(){N.checked=!N.checked},N.phd={};var q=M.appnum;N.parse=function(e){var t=r.defer();return angular.forEach(e,function(e,a){try{}catch(i){u.error(i)}finally{if("imagefile"===e.label)N.phd.imagefile=n(e.file,L),N.progresstwo++;else if("application"===e.label){var l=n(e.file,{skipEmptyLines:!0}),o={};angular.forEach(l,function(e,t){"Class / Subclass"==e[0]?o["Class Subclass"]=e[1]:o[e[0]]=e[1],N.phd.application=o}),N.progresstwo++}else"attorney"===e.label?(N.phd.attorney=n(e.file,{skipEmptyLines:!0}),N.progresstwo++):"foreign"===e.label?(N.phd.foreign=n(e.file,L,!1),N.progresstwo++):"continuity"===e.label?(N.phd.continuity=n(e.file,{skipEmptyLines:!0}),N.progresstwo++):"transaction"===e.label?(N.phd.transaction=n(e.file,L,!1),N.progresstwo++):"README"===e.label?(N.info=e.file,N.progresstwo++):"term"===e.label?(N.phd.term=n(e.file,{skipEmptyLines:!0}),N.progresstwo++):(N.error="Unhandled case!",alertify.error("unhandled case!"),t.reject("unhandled case!"));return t.resolve(N.phd)}}),t.promise},N.styleClass="panel-primary",N.size="450px",N.checked=!1,N.getpatentdownload=function(e){$(document.createElement("iframe")).attr("name","fframe").appendTo("body");var t=function(e){return E.open("https://patentimages.storage.googleapis.com/pdfs/US"+e+".pdf","fframe","resizable=no,status=no,location=no,toolbar=no,menubar=no,fullscreen=no,scrollbars=no,dependent=yes,width=400,left=150,height=30,top=150")};t(e)},N.getpublishedapplication=function(e,t){$(document.createElement("iframe")).attr("name","fframe").appendTo("body"),E.open("https://patentimages.storage.googleapis.com/pdfs/US"+e+t+".pdf","fframe","resizable=no,status=no,location=no,toolbar=no,menubar=no,fullscreen=no,scrollbars=no,dependent=yes,width=400,left=150,height=30,top=150")};var z,Y;N.getfilehistory=function(e,t){"reedtech"===t?Y():z()},Y=function(){E.open("https://patents.reedtech.com/downloads/pairdownload/"+M.appnum+".zip","_blank","resizable=no,status=no,location=no,toolbar=no,menubar=no,fullscreen=no,scrollbars=no,dependent=yes,width=400,left=150,height=30,top=150")},z=function(){E.open("https://storage.googleapis.com/uspto-pair/applications/"+M.appnum+".zip","_blank","resizable=no,status=no,location=no,toolbar=no,menubar=no,fullscreen=no,scrollbars=no,dependent=yes,width=400,left=550,height=30,top=150")},s.winreed=Y,s.wingoog=z,N.remoteconfig=function(t){$(".googlebutton").addClass("fa-spin fa-spinner").removeClass("fa-file-zip-o text-danger"),$(".reedtechbutton").addClass("fa-spin fa-spinner").removeClass("fa-file-zip-o text-danger"),l.get("/getphd/patents/"+t).then(function(t){t.data;angular.isUndefined(t.data.pub)?(M.IPANUM=null,M.IPAYEAR=null):(M.IPAYEAR=t.data.pub.slice(2,6),M.IPANUM=t.data.pub.slice(6,t.data.pub.length)),M.appnum=t.data.application_number.replace(/\D/gi,""),s.response=t.data;var a=e(M.appnum);s.application=a;var i=w.protocol()+"://"+location.host+"/proxy/storage.googleapis.com/uspto-pair/applications/"+M.appnum+".zip",n=w.protocol()+"://"+location.host+"/proxy/patents.reedtech.com/downloads/pair/"+M.appnum+".zip",o={method:"HEAD",url:n},r={method:"HEAD",url:i};s.info={video:{url:"./files/public/charm.webm",title:"PhD Tutorial",tooltip:"Click to view tutorial"}};var c={},d={};l(r).then(function(e){c.size=e.headers()["Content-Length"],s.g=c,200!==e.status?$(".googlebutton").addClass("fa-close text-danger").removeClass("fa-spin fa-spinner fa-file-zip-o"):200==e.status&&$(".googlebutton").addClass("fa-check text-success").removeClass("fa-spin fa-spinner text-danger fa-file-zip-o fa-close")}),l(o).then(function(e){d.size=e.headers()["Content-Length"],s.r=d,200!==e.status?$(".reedtechbutton").addClass("fa-close text-danger").removeClass("fa-spin fa-spinner fa-file-zip-o"):200==e.status&&$(".reedtechbutton").addClass("fa-check text-success").removeClass("fa-spin fa-spinner text-danger fa-file-zip-o fa-close")})})},s.showmetadata=y.showmetadata,N.remotezip=function(t,a){N.error=null,N.success=null,N.showprog=!0,A(function(){y.$broadcast("BUILDTABS")},5e3),M.appnum=t,l.get("/getphd/"+t+"/"+M.PNUM+"/"+M.IPAYEAR+"/"+M.IPANUM+"/"+M.id+"/"+a).then(function(e){s.phd=e.data});var i=e(M.id).$ref();i.child("rows").child("0").child("columns").child("0").child("widgets").child("0").child("config").set(M)},N.format=function(e){return e.slice(0,e.lastIndexOf("-"))},N.buffer=function(e){N.bufferedfile=e},N.success=null,N.info=null,N.phd={},N.handleFiles=function(e){N.error=null,N.success=null,N.progresstwo=0,N.extractedfiles=0,p(e,M.APPNUM,N).then(function(e){u.info("Files extracted",e),alertify.log("Files extracted"),N.phd.file=e.tsvfiles,N.parse(e.tsvfiles).then(function(e){alertify.log("TSV Parsed"),g(N.phd.application,M).then(function(t){N.phd.patent=t,o(e,N.phd,N).then(function(e){alertify.success("ROARmap built!"),N.finalize(N.phd,e)},function(e){console.log(e.message)})},function(e){console.log(e.message)})},function(e){console.log(e.message)})},function(e){console.log(e.messsage)})},N.pop=function(e){var t=angular.element("<div/>").attr("class","issuedocpanel stacker"),a={title:e.slice(e.lastIndexOf("/")+1,e.length)};s.roarevent=a;var i=O.get("{widgetsPath}/getphd/src/titleTemplate.html"),l=angular.element("<img/>").attr("class","img img-responsive img-shadow").attr("src",e);angular.element("body").append(P(t.append(i).append(l))(s)),$(".issuedocpanel").draggable({stack:".stacker",handle:"h4"}).resizable()},s.openFullScreen=function(e){s.fullscreen!==!0?($(".issuedocpanel").css({position:"absolute",top:"0px",left:"0px",bottom:"0px",right:"0px",width:"100%","z-index":"100000"}),$(".fa-expand").addClass("fa-compress").removeClass("fa-expand"),s.fullscreen=!0):($(".issuedocpanel").css({position:"absolute",top:"6rem",left:"10rem",bottom:"0rem",right:"75rem",width:"initial","z-index":"9999"}),$(".fa-compress").addClass("fa-expand").removeClass("fa-compress"),s.fullscreen=!1)},N.pushtoqueue=function(e){var t=R(),a=e.Filename.slice(0,e.Filename.indexOf("-")),i=e.Filename.slice(0,e.Filename.lastIndexOf("-"));t.$add({id:i,name:i,file:"/opt/files/public/uspto/"+a+"/"+a+"-image_file_wrapper/"+e.Filename})},N.poppatent=function(e){var t=angular.element("<div/>").attr("class","issuedocpanel stacker"),a=e;s.roarevent=a;var i=O.get("{widgetsPath}/getphd/src/titleTemplate.html"),l=angular.element("<embed/>").attr("class","img img-responsive img-shadow").attr("src",e.media);angular.element("body").append(P(t.append(i).append(l))(s)),$(".issuedocpanel").draggable({stack:".stacker",handle:"h4",contain:"#maincontent"}).resizable()},N.popdoc=function(e){var t=angular.element("<div/>").attr("class","issuedocpanel stacker"),a=O.get("{widgetsPath}/getphd/src/titleTemplate.html"),i=angular.element("<iframe/>").attr("height","680px").attr("src","./files/public/uspto/"+s.phd.appnum+"/"+s.phd.appnum+"-image_file_wrapper/"+e.Filename);angular.element("body").append(P(t.append(a).append(i))(s)),$(".issuedocpanel").draggable({stack:".stacker",handle:"h4"}).resizable()},N.finalize=function(t,a){var i=angular.copy(t.application["Application Number"]).replace("/","").replace(",","").replace(",",""),n=e(s.config.id).$ref(),o=e(x.pageid),r=(o.$ref(),e(x.pId).$ref(),new Date),c=r.getTime(),p={id:c,title:"US "+S("number")(t.patent.id,0),rid:"PHD5",styleClass:"NOA",media:t.patent.media,sortOrder:5,rows:[{styleClass:"leather",columns:[{cid:c+5,style:"col-sm-12",widgets:[{config:{id:c,PNUM:t.patent.id},type:"patent",styleClass:"NOA",wid:c+10}]}]}]};e(c).$ref().set(p),t.appnum=i,t.media="./patents/US"+t.patent.id+"/preview",t.title="PhD for "+S("number")(t.patent.id),t.description="USSN "+t.application["Application Number"],t.styleClass="Applicant",t.rid="PHD",t.icon="fa-balance-scale",angular.forEach(a,function(e,a){t.roarlist[e]=e}),t.roarlist[c]=c,t.content=t.content+I,d.set(t.application["Application Number"],t),l.post("/getphd/store/"+i,t),n.update(t),y.$broadcast("BUILDTABS"),alertify.alert('<div class="card-header"><h1 class="card-title">Prosecution History Digest for US '+t.patent.number+'</h1></div><div class="card-block"><h6 class="card-text lead"> The file has been parsed by LEO and delivered to you here for review.</h6></div>'),N.showupload=!1}}]).directive("ffFileSelect",[function(){return{restrict:"A",controller:"MainCtrl",controllerAs:"main",bindToController:!0,scope:!1,link:function(e,t,a,i){var l=i;t.on("change",function(e){l.file=(e.srcElement||e.target).files[0],l.getFile()})}}}]).factory("$patentsearch",["$q","filepickerService","$http","$document","ckstarter","ckender","$compile","$templateCache","$rootScope",function(e,t,a,i,l,n,o,r,s){return function(t,i){function o(e,t){var i=t||angular.copy(e.application["Patent Number"]).replace(",","").replace(",","");a.get("/getphd/patents/"+i).then(function(e){var t=e.data;t.number=i,t.media="./files/public/uspto/patents/"+i+"/"+i+".pdf",t.filename="US"+i+".pdf",t.google="https://www.google.com/patents/US"+i,t.rid="P1",t.styleClass="NOA",t.name="US"+i;var a=new Date(t.issued),o=a.toDateString(),s='<div class="container-fluid two-col-left"><div class="row two-col-left"><div class="col-xs-4 col-sidebar"><a pop="true" src="./patents/US'+t.number+'/preview"><img src="./patents/US'+t.number+'/preview" class="img img-responsive img-shadow"/></a></div><div class="col-xs-8 col-main"><div class="bs-callout bs-callout-NOA bs-callout-reverse"><h4>'+t.title+"</h4><p>Filed "+o+"</p><p>"+t["abstract"]+"</p><cite>"+t.filename+'&nbsp;&nbsp;<a pop="true" href="'+t.media+'" target="fframe"><i class="fa fa-external-link"></i></a></cite></div></div></div></div>',c=l,d=n,p='<p class="card-text">'+t.text+"</p>",g=angular.element(s);angular.forEach(t.drawings,function(e,a){var i=document.createElement("img"),l=document.createElement("a"),n=$(i).attr("src",t.thumbnails[a]).wrap($(l).attr("href",e).attr("target","fframe"));g.append(n)}),t.content=c+$(g).html()+p+d+'<patentreport patent="'+t.number+'"></patentreport></body></html>',r.resolve(t)})}var r=e.defer();return i.PNUM&&i.PNUM>0?o(t,i.PNUM):i.IPANUM&&o(t,i.IPAYEAR+i.IPANUM),r.promise}}]).factory("$pdftotxt",["$q","filepickerService","Collection",function(e,t,a){return function(t){function i(e){var t=e.roarmap.collections[1].id||e.roarmap.collections[1];return a(t).$loaded().then(function(e){var t=e.roarlist;angular.forEach(t,function(e,t){a(t).$loaded().then(function(e){filepicker.storeUrl(e.selflink,{filename:e.filename},function(t){filepicker.convert(t,{format:"txt"},function(t){e.txt=t.url,e.$save(),alertify.success("text file added for"+e.title)})})})})}),l.resolve(e)}var l=e.defer();return i(t),l.promise}}]).directive("pop",["$compile","$templateCache",function(t,a){return{restrict:"AC",link:function(i,l,n,o){var r=function(){var l=angular.element("<div/>").attr("class","issuedocpanel stacker"),o=a.get("{widgetsPath}/getphd/src/titleTemplate.html"),r=angular.element("<iframe/>").attr("height","60vh").attr("src",n.href);angular.element("body").append(t(l.append(o).append(r))(i)),$(".issuedocpanel").draggable({stack:".stacker",handle:"h4"}).resizable(),interact(".issuedocpanel").draggable({onmove:e.dragMoveListener}).resizable({preserveAspectRatio:!0,edges:{left:!0,right:!0,bottom:!0,top:!0}}).on("resizemove",function(e){var t=e.target,a=parseFloat(t.getAttribute("data-x"))||0,i=parseFloat(t.getAttribute("data-y"))||0;t.style.width=e.rect.width+"px",t.style.height=e.rect.height+"px",a+=e.deltaRect.left,i+=e.deltaRect.top,t.style.webkitTransform=t.style.transform="translate("+a+"px,"+i+"px)",t.setAttribute("data-x",a),t.setAttribute("data-y",i)}).on("doubletap",function(e){e.currentTarget.remove(),e.preventDefault()}),$("img").on("dblclick",function(e){$(".issuedocpanel").remove(),i.$destroy()})};l.on("click",function(e){e.preventDefault(),r()})}}}]).directive("uploadQ",["FileUploader",function(e){return{restrict:"EA",template:'<div class="card"><input type="file" nv-file-select="" uploader="uploader" multiple /> <h3>Upload queue</h3> <p>Queue length: {{ uploader.queue.length }}</p> <table class="table"> <thead> <tr> <th width="50%">Name</th> <th ng-show="uploader.isHTML5">Size</th> <th ng-show="uploader.isHTML5">Progress</th> <th>Status</th> <th>Actions</th> </tr> </thead> <tbody> <tr ng-repeat="item in uploader.queue"> <td><strong>{{ item.file.name }}</strong></td> <td ng-show="uploader.isHTML5" nowrap>{{ item.file.size/1024/1024|number:2 }} MB</td> <td ng-show="uploader.isHTML5"> <div class="progress" style="margin-bottom: 0;"> <div class="progress-bar" role="progressbar" ng-style="{ \'width\': item.progress + \'%\' }"></div> </div> </td> <td class="text-center"> <span ng-show="item.isSuccess"><i class="glyphicon glyphicon-ok"></i></span> <span ng-show="item.isCancel"><i class="glyphicon glyphicon-ban-circle"></i></span> <span ng-show="item.isError"><i class="glyphicon glyphicon-remove"></i></span> </td> <td nowrap> <button type="button" class="btn btn-success btn-xs" ng-click="item.upload()" ng-disabled="item.isReady || item.isUploading || item.isSuccess"> <span class="glyphicon glyphicon-upload"></span> Upload </button> <button type="button" class="btn btn-warning btn-xs" ng-click="item.cancel()" ng-disabled="!item.isUploading"> <span class="glyphicon glyphicon-ban-circle"></span> Cancel </button> <button type="button" class="btn btn-danger btn-xs" ng-click="item.remove()"> <span class="glyphicon glyphicon-trash"></span> Remove </button> </td> </tr> </tbody> </table> <div> <div> Queue progress: <div class="progress" style=""> <div class="progress-bar" role="progressbar" ng-style="{ \'width\': uploader.progress + \'%\' }"></div> </div> </div> <button type="button" class="btn btn-success btn-s" ng-click="uploader.uploadAll()" ng-disabled="!uploader.getNotUploadedItems().length"> <span class="glyphicon glyphicon-upload"></span> Upload all </button> <button type="button" class="btn btn-warning btn-s" ng-click="uploader.cancelAll()" ng-disabled="!uploader.isUploading"> <span class="glyphicon glyphicon-ban-circle"></span> Cancel all </button> <button type="button" class="btn btn-danger btn-s" ng-click="uploader.clearQueue()" ng-disabled="!uploader.queue.length"> <span class="glyphicon glyphicon-trash"></span> Remove all </button> </div> </div>',controller:"AppController",controllerAs:"uploader",bindToController:!0,scope:{url:"@"},link:function(e,t,a,i){}}}]).controller("AppController",["$scope","FileUploader",function(e,t){var a=e.uploader=new t({url:e.url||"./upload",autoUpload:!0});a.filters.push({name:"customFilter",fn:function(e,t){return this.queue.length<10}}),a.onWhenAddingFileFailed=function(e,t,a){console.info("onWhenAddingFileFailed",e,t,a)},a.onAfterAddingFile=function(e){console.info("onAfterAddingFile",e)},a.onAfterAddingAll=function(e){console.info("onAfterAddingAll",e)},a.onBeforeUploadItem=function(e){console.info("onBeforeUploadItem",e)},a.onProgressItem=function(e,t){console.info("onProgressItem",e,t)},a.onProgressAll=function(e){console.info("onProgressAll",e)},a.onSuccessItem=function(e,t,a,i){console.info("onSuccessItem",e,t,a,i)},a.onErrorItem=function(e,t,a,i){console.info("onErrorItem",e,t,a,i)},a.onCancelItem=function(e,t,a,i){console.info("onCancelItem",e,t,a,i)},a.onCompleteItem=function(e,t,a,i){console.info("onCompleteItem",e,t,a,i)},a.onCompleteAll=function(){console.info("onCompleteAll")},console.info("uploader",a)}]).controller("GalleryCarouselController",["$scope","config","Collection","$rootScope","$ACTIVEROAR",function(e,t,a,i,l){var n=this,t=t;e.config=t,n.slides=[],t.id?a(t.id).$loaded().then(function(e){angular.forEach(e.roarlist,function(e,t){a(e).$loaded().then(function(e){n.slides.push(angular.copy(e))})})}):(a(l.page).$loaded().then(function(e){angular.forEach(e.roarlist,function(e,t){a(e).$loaded().then(function(e){n.slides.push(angular.copy(e))})})}),n.slides.push({title:"DemoSlide",media:"/llp_core/img/lexlab.svg"}),n.slides.push({title:"PatentPhD",media:"/llp_core/img/logolong.png"}))}]).controller("GalleryCarousel",["",function(){}]).directive("ngThumb",["$window",function(e){var t={support:!(!e.FileReader||!e.CanvasRenderingContext2D),isFile:function(t){return angular.isObject(t)&&t instanceof e.File},isImage:function(e){var t="|"+e.type.slice(e.type.lastIndexOf("/")+1)+"|";return"|jpg|png|jpeg|bmp|gif|".indexOf(t)!==-1}};return{restrict:"A",template:"<canvas/>",link:function(e,a,i){function l(e){var t=new Image;t.onload=n,t.src=e.target.result}function n(){var e=o.width||this.width/this.height*o.height,t=o.height||this.height/this.width*o.width;r.attr({width:e,height:t}),r[0].getContext("2d").drawImage(this,0,0,e,t)}if(t.support){var o=e.$eval(i.ngThumb);if(t.isFile(o.file)&&t.isImage(o.file)){var r=a.find("canvas"),s=new FileReader;s.onload=l,s.readAsDataURL(o.file)}}}}}]).controller("PatentWidgetCtrl",["$scope","config","$sce","$http","Collection","$q","$filter","$sanitize","$patentsearch","$compile","PageManager","$rootScope","$templateCache",function(e,a,i,l,n,o,r,s,c,d,p,g,u){var b=this;b.remoteconfig=function(e){l.get("/getphd/patents/"+e).then(function(e){e.data;angular.isUndefined(e.data.pub)?(a.IPANUM=null,a.IPAYEAR=null):(a.IPAYEAR=e.data.pub.slice(2,6),a.IPANUM=e.data.pub.slice(6,e.data.pub.length))})},b.getdata=function(e){var t=o.defer();return c(e,a).then(function(e){return t.resolve(e)}),t.promise},b.sanitize=s,b.getdigest=function(e){p.insert(a.id,"Patent").then(function(t){var a=n(t).$ref(),i=e.replace(/[\:us]/gi,"");a.child("rows").child("0").child("columns").child("0").child("widgets").child("0").child("config").child("PNUM").set(i),a.update({title:e}),g.$broadcast("BUILDTABS")})};var a=e.$parent.config||e.$parent.$parent.config,f=n(a.id);if(f.$bindTo(e,"collection"),e.config=a,e.cupdate=function(t){var a=f.$ref();a.child("rows").child("0").child("columns").child("0").child("widgets").child("0").child("config").update(t),a.child("rows").child("0").child("columns").child("0").child("widgets").child("1").update({type:"iframe",config:{url:e.patent.media}}),a.child("rows").child("0").child("columns").child("0").child("widgets").child("2").update({type:"ckwidget",config:{id:f.$id}}),a.child("rid").set("π"),a.child("media").set(e.patent.media),a.child("date").set(e.patent.date)},b.configure=function(e){var t=r("strip")(e);return t},b.preparescope=function(t,a){a.application_data=t,e.patent=a;try{var i=angular.isDefined(a)?a.backward_citations:t.backward_citations;u.put("{"+(angular.isDefined(a)?a.id:t.id)+"}/backtable.html",i.replace(/<a\s(?!pop)/g,"<a pop ")),b.linker="{"+(angular.isDefined(a)?a.id:t.id)+"}/backtable.html";var l=angular.isDefined(a)?a.forward_citations||"<h4>Forward Citations</h4>":t.forward_citations||"<h4>Forward Citations</h4>";u.put("{"+(angular.isDefined(a)?a.id:t.id)+"}/forwtable.html",l.replace(/<a\s(?!pop)/g,"<a pop ")),b.linker1="{"+(angular.isDefined(a)?a.id:t.id)+"}/backtable.html"}catch(n){console.log(n)}finally{b.showform=!1,b.showconfig=!1}},b.getnew=function(e){try{var a=n(e).$loaded()}catch(i){}finally{var a=b.getdata(e);a.then(function(e){if(e.pub!==t){var a=b.configure(e.pub);b.getdata(a).then(function(t){b.preparescope(t,e)})}else b.preparescope(null,e)})}},b.getload=function(e){n(e).$loaded().then(function(e){if(e.pub!==t){var a=b.configure(e.pub);n(a).$loaded().then(function(t){b.preparescope(t,e)})}else b.preparescope(null,e)})},angular.isUndefined(a.PNUM)?(b.showconfig=!0,b.showform=!1):b.getnew(a.PNUM),a.PNUM)try{b.getnew(a.PNUM)}catch(m){var h=a.IPAYEAR+a.IPANUM}finally{alertify.success("loaded")}else try{var h=a.IPAYEAR+a.IPANUM;b.getnew(h)}catch(m){var h=a.IPAYEAR+a.IPANUM;b.getdata(h)}finally{alertify.success("loaded")}}]).directive("claimtree",function(){return{restrict:"E",templateUrl:"/getphdwidget/src/phd/claimtree.html",scope:{tree:"=",query:"="},link:function(e,t,a){}}}).filter("citationcheck",function(){return function(e){var t=function(e){var t=new RegExp(/\<a\s/gi);return e.replace(t,"<a pop ")};return t(e)}}).filter("capturelinks",["$timeout","$compile","$sce","$rootScope",function(e,t,a,i){return function(e){if(!angular.isUndefined(e)&&null!==e){var l=e,n=function(){return a.trustAsHtml(t(l.replace(/href/gim,"pop href"))(i.$new()))};return n()}}}]).directive("rejectionset",function(){return{restrict:"EA",templateUrl:"{widgetsPath}/getphd/src/rejectionset.html",scope:{set:"="},link:function(e,t,a,i){}}}).directive("rejection",function(){return{restrict:"EA",templateUrl:"{widgetsPath}/getphd/src/rejection.html",scope:{rejection:"="},link:function(e,t,a,i){}}}).controller("MetadataController",["filepickerService","$firequeue","$rootScope","Collection","config","$scope","$stateParams","Upload","$http","toastr","DOCNAMES",function(e,t,a,i,l,n,o,r,s,c,d){var l=n.$parent.config||n.$parent.$parent.config;n.config=l,n.save=function(e){n.config=e};var p=o.pId,g=i(p);n.tree=g,n.onSubmit=function(e){i(l.id).$save(e)};var u=[];angular.forEach(d,function(e,t){angular.forEach(e,function(e,t){var a={code:t,label:t+" - "+e};u.push(a)})}),n.DOCNAMES=u,n.pushtoqueue=function(e){var i=t(),l=e.id,n=e.filename||e.title,o=a.authData.uid;i.$add({id:l,name:n,file:"/opt/files/"+o+"/"+n})},n.importFile=function(e){var t=new Blob([e.media,e.content],i),a={method:"POST",url:"/import",data:{url:e.media,name:e.filename||e.title,file:t}};s(a).then(function(t){angular.isString(t.data.newurl)&&(e.media=t.data.newurl,e.$save())});var i={url:e.media,filename:e.filename,mimetype:e.mimetype,isWriteable:!0,size:100};r.upload({url:"/upload/",data:{file:Blob}}).then(function(t){dialog.close(),console.log(t),n.pushtoqueue(e),console.log("Success "+t.config.data.file.name+"uploaded. Response: "+t.data)},function(e){console.log("Error status: "+e.status)},function(e){var t=parseInt(100*e.loaded/e.total);n.progress=t,10===t&&c.info("fetching remote resources..."),30===t&&c.info("loading relevant data schemas..."),55===t&&c.warning("compiling templates..."),75===t&&c.warning("starting the AI engine..."),t<=40?n.progresstype="danger":t>40&&t<66?n.progresstype="warning":t>97?n.progresstype="success":n.progresstype="info",console.log("progress: "+t+"% "+e.config.data.file.name)})}}]).controller("RepoController",["$scope","$http","$location","Collection",function(e,t,a,i){var l=this,n=[],o=i("REPORT");e.reporter=o;var r={method:"GET",url:"/report/all"};o.$loaded().then(function(t){angular.forEach(e.reporter.meta,function(e,t){e.id=t,n.push(e)}),e.arra=n});t(r).then(function(e){l.filehistories=e.data}),l.dofunction=function(a){var i=a.funconfig,l={method:"GET",url:"/getphd/"+i.APPNUM+"/"+i.PNUM+"/"+i.IPAYEAR+"/"+i.IPANUM+"/"+i.id};t(l).then(function(t){e.report=t.data})}}]).directive("claimtreetabhtml",function(){return{restrict:"EA",templateUrl:"{widgetsPath}/getphd/src/claimtreetab.html",scope:{config:"="},link:function(e,t,a,i){}}});angular.module("adf.widget.getphd").run(["$templateCache",function(e){e.put("{widgetsPath}/getphd/src/claims.html",'<input ng-model=config.PNUM type=number placeholder="patent number" ng-model-options="{updateOn: \'blur\'}"> <button clipboard text={{claims}}>CLAIMS</button> <button clipboard text={{remarks}}>REMARKS</button> <button clipboard text={{rejections}}>REJECTIONS</button><d3historytree patent={{config.PNUM}}></d3historytree><uib-tabset justified=true><uib-tab ng-repeat="(key, set) in roarevent.roarlist" node={{key}} deselect=sortSet(node)><uib-tab-heading><h6 class=card-title>{{::node.title}} {{$index}}</h6><strong class=card-subtitle>{{node.date | date}}</strong><a pop ng-href={{node.media}} class="fa fa-external-link showonhover">{{node.claims.length}}</a></uib-tab-heading><uib-tab-content class="card-block card-columns"><div class="col-sm-8 card card-Applicant" ng-repeat="claim in node.claims track by $index"><label ng-class="{\'dependent\':(prent(node.claims[$index]) > -1), \'independent\':(!prent(node.claims[$index]))}" class="display-1 label label-pill node pull-right" style=padding:10px;position:absolute;right:5px;top:5px;font-size:18px;font-weight:600; colorkey={{statustest(node.claims[$index])}} uib-tooltip={{statustest(node.claims[$index])}} tooltip-triggers="mouseenter click" tooltip-animation=true tooltip-offset=50px tooltip-placement=top>{{num(node.claims[$index])||\'-\'}}</label><textarea class=card-block style=font-size:16px;color:#444; ng-model=node.claims[$index] ng-model-options="{updateOn:\'blur\',debounce:{\'blur\':0}}" cols=100 rows=4 ng-blur="checkValid($index, node)" placeholder="XX. Lorem non irure sunt enim consequat."></textarea><br><a class="fa fa-close text-danger" ng-click="node.claims[$index]=null" style=align-self:flex-end;></a> <a ng-click="addClaim($index, node)" class="text-success fa fa-plus" style=align-self:center;></a></div></uib-tab-content></uib-tab></uib-tabset>'),
